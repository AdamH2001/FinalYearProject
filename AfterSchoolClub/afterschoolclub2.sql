...
VALUES ((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Milk"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Drinks"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Water"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Drinks"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Orange Juice"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Drinks"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Ham Sandwich"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Food"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Cheese Sandwich"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Food"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Bacon Sandwich"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Food"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Apple"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Fruit"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Banana"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Fruit"))
,((SELECT menu_option_id from after_school_club2.menu_option WHERE name="Pear"),(SELECT menu_group_id from after_school_club2.menu_group WHERE name="Fruit"));
...
,("peterjones@hattonsplace.co.uk","QmFzaW5nc3Rva2UxMg==","Peter","Jones","6000000",'2022-12-27',True);
